...
public class WarehouseTests
{
    ...
    public void TestAddProduct()
    {
        ...
        Assert.AreEqual("Product A", warehouse.ProductCatalog[1]); Assert.IsTrue(warehouse.Inventory.ContainsKey(1));
    ...
    public void TestRecordOutgoingShipment_Successful()
    {
        ...
        Assert.That(warehouse.Inventory[1], Is.EqualTo(50));
    }
    [Test]
    public void TestRecordOutgoingShipment_InsufficientStock()
    {
        ...
        Assert.IsFalse(result); Assert.That(warehouse.Inventory[1], Is.EqualTo(100));
    }
}